...
class UPackPackagesBatchRequest(Model):
    ...
    :type data: :class:`BatchOperationData <uPack.v5_0.models.BatchOperationData>`
    ...
    :type packages: list of :class:`MinimalPackageDetails <uPack.v5_0.models.MinimalPackageDetails>`
    """
