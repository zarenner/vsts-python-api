...
class UPackPackagingClient(VssClient):
    """UPackPackaging
    ...
    def add_package(self, metadata, feed_id, package_name, package_version):
        """AddPackage.
        [Preview API]
        :param :class:`<UPackPackagePushMetadata> <uPack-packaging.v5_0.models.UPackPackagePushMetadata>` metadata:
        :param str feed_id:
    ...
    def get_package_metadata(self, feed_id, package_name, package_version, intent=None):
        ...
        :param str package_version:
        :param str intent:
        :rtype: :class:`<UPackPackageMetadata> <uPack-packaging.v5_0.models.UPackPackageMetadata>`
        """
        route_values = {}
        if feed_id is not None:
            route_values['feedId'] = self._serialize.url('feed_id', feed_id, 'str')
