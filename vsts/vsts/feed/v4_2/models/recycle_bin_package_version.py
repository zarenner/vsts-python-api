...
class RecycleBinPackageVersion(PackageVersion):
    ...
    :type version: str
    :param views:
    :type views: list of :class:`FeedView <packaging.v4_2.models.FeedView>`
    :param _links:
    :type _links: :class:`ReferenceLinks <packaging.v4_2.models.ReferenceLinks>`
    :param author:
    :type author: str
    :param deleted_date:
    :type deleted_date: datetime
    :param dependencies:
    :type dependencies: list of :class:`PackageDependency <packaging.v4_2.models.PackageDependency>`
    :param description:
    :type description: str
    :param files:
    :type files: list of :class:`PackageFile <packaging.v4_2.models.PackageFile>`
    :param other_versions:
    :type other_versions: list of :class:`MinimalPackageVersion <packaging.v4_2.models.MinimalPackageVersion>`
    :param protocol_metadata:
    :type protocol_metadata: :class:`ProtocolMetadata <packaging.v4_2.models.ProtocolMetadata>`
    :param source_chain:
    :type source_chain: list of :class:`UpstreamSource <packaging.v4_2.models.UpstreamSource>`
    :param summary:
    :type summary: str
    :param tags:
