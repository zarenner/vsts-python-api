...
class Feed(FeedCore):
    ...
    :type upstream_sources: list of :class:`UpstreamSource <packaging.v4_2.models.UpstreamSource>`
    :param view:
    :type view: :class:`FeedView <packaging.v4_2.models.FeedView>`
    :param view_id:
    :type view_id: str
    :param view_name:
    :type view_name: str
    ...
    :param permissions:
    :type permissions: list of :class:`FeedPermission <packaging.v4_2.models.FeedPermission>`
