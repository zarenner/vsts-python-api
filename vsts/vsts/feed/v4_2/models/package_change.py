...
class PackageChange(Model):
    ...
    :param package:
    :type package: :class:`Package <packaging.v4_2.models.Package>`
    :param package_version_change:
    :type package_version_change: :class:`PackageVersionChange <packaging.v4_2.models.PackageVersionChange>`
    """
